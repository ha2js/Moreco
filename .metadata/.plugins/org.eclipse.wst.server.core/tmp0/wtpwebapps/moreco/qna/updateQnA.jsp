...
<body>
	...
	<div id="wrap">
		...
		<section>
			<span class="title">문의 - 수정</span><br>
			<form method="post" name="qna_fr" action="updateQnA_Pro.jsp" onsubmit="return checkWriteQna();">
				<div class="qnaWrite">
					<div class="form-floating mb-3">
						<input type="text" class="form-control" name="qna_title" id="floatingInput" style="width:559px;" placeholder="영화명" value="<%=qd.getQna_title()%>" readonly="readonly" >
						<label for="floatingInput">제목</label>
					</div>
					
				    <div class="form-floating">
				        <textarea class="form-control" name="qna_content" placeholder="Leave a comment here" id="floatingTextarea2" style="width:659px; height: 200px;"><%=qd.getQna_content() %></textarea>
