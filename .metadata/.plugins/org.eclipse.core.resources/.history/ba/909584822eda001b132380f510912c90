	 ...
	 <header class="p-3 bg-dark text-white">
		<div class="container">
			<div
				...
				<a href="main.jsp?sideIdx=0"><img src="images/moreco_logo.png" class="logoimg"
				...
				<div class="text-end">
					<div class="btn-group">
					<button type="button" class="btn btn-danger" style="<%=display_none%>" onClick="location.href='addmovie.jsp?sideIdx=8'">Add</button>
