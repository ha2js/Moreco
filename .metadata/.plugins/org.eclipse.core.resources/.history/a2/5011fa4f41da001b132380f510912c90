...
<body>
	...
	<div id="wrap">
		...
		<section>
			...
			<table>
				<tr>
					<td class="btn_td" rowspan="6"><button type="button" class="btn btn-secondary">&laquo;</button></td>
					<td class="img_td"><img src="images/test.jpg"></td>
					<td class="img_td"></td>
					<td class="img_td"></td>
					<td class="img_td"></td>
					<td class="btn_td" rowspan="6"><button type="button" class="btn btn-secondary">&raquo;</button></td>
				</tr>
				<tr>
					<td>7번방의 선물</td>
					<td></td>
