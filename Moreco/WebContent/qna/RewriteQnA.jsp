...
<body>
	...
	<div id="wrap">
		...
		<section>
			<span class="title">답변하기</span><br>
			<form method="post" name="qna_rfr" action="RewriteQnA_Pro.jsp" onsubmit="return checkWriteQna();">
				<div class="qnaWrite">
					<div class="form-floating mb-3">
						<input type="text" class="form-control" name="qna_title" id="floatingInput" style="width:559px;" readonly="readonly" value="답변:<%=title%>">
